...
> Note: This project is using [Angular Library](https://angular.io/guide/libraries). so the library I created for Authenticatuion **AuthLib** -which contains services and `Ngrx/store, Ngrx/Effects, Ngrx/entity`  sould be built before anything.
